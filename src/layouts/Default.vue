<template>
  <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
    <header class="top-0 left-0 z-40 fixed w-full border-t-14 border-green-700" style="border-color : crimson ;">
    ...
    <footer class="bg-green-700 text-white" style="background-color : crimson ">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        <div class="mb-8 lg:mb-0">
          <div>Copyright {{ new Date().getFullYear() }}. For learning Gridsome Only.</div>
          <div>
        ...
        <ul class="flex items-center space-x-8">
          ...
          <li>
            <a href="https://github.com/nksoluna" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://twitter.com/Xsoluna" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://instagram.com/noriniks" target="_blank" class="text-white hover:text-gray-400">
